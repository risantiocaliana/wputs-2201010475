    ...
    switch ($act) {
        case "store":
            ...
            if ($pass1 == $pass2) {
                ...
                $user = $_POST["txUSER"];
                $iduser = md5($email);
                $sql = "INSERT INTO tbmahasiswa (nama, email, username, passkey, iduser) VALUES ('$nama','$email','$user','$pass1','$iduser');";
        ...
        case "update":
            ...
            if ($pass1 == $pass2) {
                ...
                $user = $_POST["txUSER"];
                $iduser = $_POST["iduser"];
                $sql = "UPDATE tbmahasiswa SET nama='$nama', email='$email', username='$user', passkey='$pass1' WHERE iduser='$iduser';";
                $hasil = mysqli_query($cnn, $sql);
                if ($hasil) {
                    $footer = "<script>
                    Swal.fire({
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="datamk.php">Data Mata Kuliah</a>
                        </li>
                        <li class="nav-item">
